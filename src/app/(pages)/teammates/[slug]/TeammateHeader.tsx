  ...
  return (
    <div className="grid grid-cols-1 xl:grid-cols-2 gap-4">
      <div>
        ...
        <p className="text-center xl:text-left xl:w-3/4 w-full">{shortDescription}</p>

        <div className="bg-wwRed p-8 max-w-[38rem] xl:w-3/4 w-full mt-16 mx-auto xl:mx-0 text-center lg:text-left">
          <h4 className="text-white">About Me</h4>
          <div className="flex flex-col gap-4 mt-4 items-center lg:items-start">
            {strength && (
              <span className="inline-flex text-white gap-2">
                <svg
