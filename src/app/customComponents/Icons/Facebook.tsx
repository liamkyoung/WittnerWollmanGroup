...
function Facebook({ profileLink, username, colorScheme = ColorScheme.DEFAULT }: Props) {
  ...
  return (
    <Link href={profileLink}>
      <span className={`inline-flex gap-4 ${textColor}`}>
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" className={colorStyle}>
