...
//         <h1 className="mb-2 mt-6 text-wwBlack">{'The Reflection'}</h1>
//         <CardInfo address="Downtown St. Petersburg" />
//       </div>
//       <div className="flex lg:flex-row flex-col items-end justify-end gap-x-4 flex-wrap">
//         <Link href={'https://www.reflectionstpete.com'}>
...
//               />
//             </svg>
//             <p className="text-wwRed hidden md:block">
//               {'www.reflectionstpete.com'}
//             </p>
//           </div>
//         </Link>

//         <Link href={DefaultSocials.instagram}>
//           <div className="inline-flex gap-2">
//             <svg
//               xmlns="http://www.w3.org/2000/svg"
//               viewBox="0 0 448 512"
...
//       <Image src={ReflectionPool} alt="fullbody-img" className="w-full" />
//       <button className="absolute bottom-0 right-0 btn-primary">
//         SEE FULL GALLERY
//       </button>
//     </div>
//   </div>
